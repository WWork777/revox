export const metadata = {
	...
	description:
		'Вокал, запись песен, сведение, написание музыки — всё в ВОКС, топ-студии Кемерова. Раскрой свой голос с командой профи!',
	alternates: {
	...
	openGraph: {
		title: 'Студия звукозаписи и вокала ВОКС в Кемерово',
		description:
			'Вокал, запись песен, сведение, написание музыки — всё в ВОКС, топ-студии Кемерова. Раскрой свой голос с командой профи!',
		url: `https://vox42.ru/`,
		images: [
			{
				...
				alt: 'Студия звукозаписи и вокала ВОКС в Кемерово',
			},
		],
	},
}
